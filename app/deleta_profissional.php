    ...
    <body>
        <div class="container theme-showcase" role="main">
            <?php 
                ...
                if(!empty($id)){ 
                    $result_usuario = "DELETE FROM profissional WHERE id='$id'";
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Profissional deletado com sucesso!</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>O profissional foi deletado com sucesso, volte para a página de profissionais!</p>
                                    </div>
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="modal fade" id="modal_erro" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Erro ao deletar profissional!</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <p>Não foi possível deletar o profissional, tente novamente!</p>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <div class="modal fade" id="modal_erro2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>Necessário selecionar um profissional!</p>
                                </div>
                                <div class="modal-footer">
                                    <a href="profissional.php"><button type="button" class="btn btn-danger">Fechar</button></a>
                                </div>
